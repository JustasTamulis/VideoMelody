...
import numpy as np
from models.m2.discriminator import discriminator
from models.m2.generator import generator
import os
...
class GAN():
    ...
    def train_step(self, note_batch, img_data_batch, roll_data_batch, BATCH_SIZE, log_g, log_d, verbose):
        ...
        return d_loss_real, d_acc_real, d_loss_fake, d_acc_fake, g_loss.history['loss'][0], g_loss.history['binary_accuracy'][0], diff_pitches
