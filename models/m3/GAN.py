...
import numpy as np
from models.m3.discriminator import discriminator
from models.m3.generator import generator
import os
...
class GAN3():
    ...
    def train_step(self, cond_roll_batch, cond_note_batch, img_data_batch, roll_data_batch, BATCH_SIZE, log_g, log_d, verbose):
        ...
        cond_note_half_batch = cond_note_batch[:HALF_BATCH]
        ...
        [d_loss_real, d_acc_real] = self.d.evaluate([img_data_half_batch, cond_note_half_batch, note_half_batch], valid_half, verbose, HALF_BATCH)
        [d_loss_fake, d_acc_fake] = self.d.evaluate([img_data_half_batch, generated_roll, note_half_batch], half_fake, verbose, HALF_BATCH)

        if d_loss_real > 0.05:
            d_real_hist = self.d.train([img_data_half_batch, cond_note_half_batch, note_half_batch], valid_half, log_d, verbose, HALF_BATCH)
