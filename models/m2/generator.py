...
class generator():
    ...
    def build_model(self, random_size, image_shape, roll_size, sequence_length):
        ...
        l_piano = layers.Dense(sequence_length*2,activation='relu')(l_piano)
        l_piano = layers.Reshape((sequence_length,2))(l_piano)
        ...
        # --------------------------------------------------
        # define model
        model = Model([li_image, li_ran, li_piano], soft_out)
